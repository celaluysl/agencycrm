...
export function TicketChat() {
    ...
    const handleSendMessage = () => {
        ...
        setMessages({
            ...messages,
            [activeTicketId]: [...(messages[activeTicketId] || []), newMessage]
        });
        setMessage("");
    };
                ...
                {activeTicket ? (
                    <>
                        <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30 flex justify-between items-center z-10">
                            ...
                            <Button variant="outline" size="sm" className="h-8 text-xs text-red-500 hover:text-red-700 hover:bg-red-50 border-red-200">
                                Talebi Kapat
                            </Button>
                        </div>
                    ...
                    <div className="bg-white dark:bg-[#1a2432] rounded-2xl w-full max-w-md shadow-xl overflow-hidden border border-gray-200 dark:border-gray-800">
                        ...
                        <div className="p-5 space-y-4">
                            <div>
                                ...
                                <input type="text" className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 text-sm focus:ring-1 focus:ring-primary dark:bg-gray-800 bg-white dark:bg-[#1a2432]" placeholder="Örn: Fatura Hakkında" />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-1">Kategori</label>
                                    <select className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 text-sm focus:ring-1 focus:ring-primary dark:bg-gray-800 bg-white dark:bg-[#1a2432]">
                            ...
                            <div>
                                ...
                                <textarea rows={4} className="w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 text-sm focus:ring-1 focus:ring-primary dark:bg-gray-800 bg-white dark:bg-[#1a2432]" placeholder="Sorununuzu veya talebinizi detaylıca açıklayın..."></textarea>
                            </div>
                            <div>
                                <button className="flex items-center gap-2 text-primary text-xs font-bold border border-primary/30 bg-primary/5 hover:bg-primary/10 px-3 py-2 rounded-lg w-full justify-center transition-colors border-dashed relative">
                                    <span className="material-symbols-outlined text-base">upload_file</span> Dosya Yükle
                        ...
                        <div className="p-4 border-t border-gray-100 dark:border-gray-800 flex justify-end gap-2 bg-gray-50/50 dark:bg-gray-800/30">
                            ...
                            <Button onClick={() => setIsModalOpen(false)}>Talebi Oluştur</Button>
                        </div>
                    </div>
                </div>
            )}
