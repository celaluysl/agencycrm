...
<h1 className="text-[#111418] dark:text-white text-xl font-bold">Haftalık Reels İçerik Planlama ve Kurgu</h1>
<p className="text-xs text-[#617289] uppercase font-semibold tracking-wider">Proje: Teksan Global - Sosyal Medya Yönetimi</p>
</div>
</div>
<div className="flex items-center gap-3">
...
<p>Hedef, markanın Instagram ve TikTok etkileşimlerini artıracak 3 adet Reels içeriğinin planlanması ve kurgulanmasıdır. İçeriklerin marka kimliğine uygunluğunu kontrol edin.</p>
</div>
</section>
...
<span className="text-sm text-[#111418] dark:text-white font-medium">Trend müzik ve ses seçimi yapıldı mı?</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Video kurgusu ve renk düzenlemesi tamamlandı mı?</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Altyazılar ve anahtar kelimeler eklendi mi?</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Kapak görseli (Thumbnail) marka standartlarına uygun mu?</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Paylaşım için müşteri onayı alındı mı?</span>
</label>
</div>
</section>
...
<p className="text-sm text-[#4b5563] dark:text-gray-300">Selam <span className="text-primary font-semibold">@Can</span>, Reels kurguları için seçtiğin müzikler markanın genç kitlesine çok uygun olmuş. Kurgu detaylarını bekliyorum.</p>
</div>
</div>
</div>
...
<p className="text-[10px] text-gray-500">Şu anki çalışma: Reels Kurgu</p>
</div>
</div>
...
<span className="text-xs font-medium dark:text-white truncate">icerik_plani_v1.pdf</span>
