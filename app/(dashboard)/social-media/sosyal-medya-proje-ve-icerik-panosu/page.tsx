...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">İçerik Fikirleri</h3>
<span className="bg-slate-200 dark:bg-slate-800 text-slate-500 px-1.5 py-0.5 rounded text-[10px] font-bold">5</span>
</div>
...
<span className="bg-purple-100 text-purple-600 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Story</span>
<div className="flex items-center gap-1.5 text-slate-400 text-[10px]">
<span className="material-symbols-outlined text-sm">schedule</span>
<span>Est: 1s</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Haftalık Soru-Cevap Story Planlaması</h4>
...
<div className="flex justify-between items-start mb-3">
<span className="bg-emerald-100 text-emerald-600 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Post</span>
<div className="flex items-center gap-1.5 text-slate-400 text-[10px]">
<span className="material-symbols-outlined text-sm">schedule</span>
<span>Est: 3s</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Ürün Odaklı Carousel Tasarımı: Sonbahar Koleksiyonu</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Tasarım / Kurgu</h3>
<span className="bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded text-[10px] font-bold">2</span>
</div>
</div>
<div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-hide">
...
<div className="flex justify-between items-start mb-3">
<span className="bg-rose-100 text-rose-600 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Reels</span>
<div className="flex items-center gap-1.5 text-primary text-[10px] font-bold">
<span className="material-symbols-outlined text-sm animate-spin-slow">timer</span>
<span>00:45:12</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Instagram Reels Video Kurgusu: Ofis Günlükleri</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<div className="flex flex-col">
<span className="text-[10px] text-slate-400 leading-none">Atanan</span>
<span className="text-[11px] font-bold text-slate-700 dark:text-slate-300">Mert Soydan</span>
</div>
</div>
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Müşteri Onayında</h3>
<span className="bg-amber-100 text-amber-600 px-1.5 py-0.5 rounded text-[10px] font-bold">1</span>
</div>
</div>
<div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-hide">
...
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Kasım Ayı İndirim Kampanyası Görsel Seti Onayı</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Planlandı / Paylaşıldı</h3>
<span className="bg-emerald-100 text-emerald-600 px-1.5 py-0.5 rounded text-[10px] font-bold">12</span>
</div>
</div>
<div className="flex-1 overflow-y-auto space-y-4 pr-2 scrollbar-hide">
...
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4 line-through">Eğitici İçerik: "Doğru Kombin Nasıl Yapılır?" Reels</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
