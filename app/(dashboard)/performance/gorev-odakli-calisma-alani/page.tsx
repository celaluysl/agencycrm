...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Yapılacaklar</h3>
...
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Google Ads Arama Ağı Metinlerinin Yeni Kampanya İçin Güncellenmesi</h4>
...
<div className="flex justify-between items-start mb-3">
<span className="bg-blue-100 text-blue-600 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Normal</span>
<div className="flex items-center gap-1.5 text-slate-400 text-[10px]">
<span className="material-symbols-outlined text-sm">schedule</span>
<span>Est: 2.5s</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Yeni Remarketing Listelerinin Oluşturulması ve Segmentasyonu</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">İşlemde</h3>
...
<div className="flex justify-between items-start mb-3">
<span className="bg-orange-100 text-orange-600 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Yüksek</span>
...
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Facebook Katalog Reklamı Optimizasyonu ve Kreatif Testleri</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Kontrol / Onay</h3>
...
<span>Dün Gönderildi</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4">Ekim Ayı Detaylı Performans Raporunun Hazırlanması ve Sunumu</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
...
<h3 className="font-bold text-xs uppercase text-slate-500 tracking-wider">Tamamlandı</h3>
...
<div className="flex justify-between items-start mb-3">
<span className="bg-slate-100 text-slate-500 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">Normal</span>
<div className="flex items-center gap-1.5 text-emerald-500 text-[10px]">
<span className="material-symbols-outlined text-sm">verified</span>
<span>Tamamlandı</span>
</div>
</div>
<h4 className="text-sm font-bold text-slate-800 dark:text-slate-100 leading-snug mb-4 line-through">Meta Pixel Kurulumu, Dönüşüm API ve Test Süreci</h4>
<div className="flex items-center justify-between pt-3 border-t border-slate-50 dark:border-slate-700/50">
<div className="flex items-center gap-2">
