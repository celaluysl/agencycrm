...
<h1 className="text-[#111418] dark:text-white text-xl font-bold">Google Ads Kampanya Optimizasyonu</h1>
<p className="text-xs text-[#617289] uppercase font-semibold tracking-wider">Proje: E-Ticaret Dönüşüm Kampanyası</p>
</div>
</div>
<div className="flex items-center gap-3">
...
<p>Hedef, E-Ticaret Dönüşüm Kampanyasının performansını artırmak ve ROAS hedeflerini yakalamaktır. Lütfen SEM departmanı standartlarına uygun olarak aşağıdaki SOP adımlarını tamamlayın.</p>
<ul className="list-disc ml-4 space-y-1">
<li>Mevcut ROAS Hedefi: %450</li>
<li>Günlük Bütçe: 1.500 TL</li>
</ul>
</div>
</section>
...
<p className="text-[#111418] dark:text-white text-sm font-bold">2/5</p>
...
<span className="text-sm text-gray-500 line-through">Negatif anahtar kelimeleri kontrol et</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input defaultChecked className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-gray-500 line-through">Tıklama başı maliyetleri (TBM) analiz et</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Reklam metni performansını incele</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Dönüşüm oranlarını raporla</span>
</label>
<label className="flex items-center gap-3 p-3 bg-white dark:bg-background-dark border border-[#e5e7eb] dark:border-[#2d3748] rounded-lg cursor-pointer hover:border-primary/50 transition-colors">
<input className="rounded border-gray-300 text-primary focus:ring-primary h-4 w-4" type="checkbox" />
<span className="text-sm text-[#111418] dark:text-white font-medium">Bütçe dağılımını optimize et</span>
</label>
</div>
</section>
...
<div className="size-8 rounded-full bg-cover bg-center shrink-0" data-alt="Team member Sarah" style={{ "backgroundImage": "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDvca6uENs1mszCQw1yI6tZEVAb1FuSvK2pWIj4MAhQNFxlpnrTXTKUdrWLp5VRh0OaoN5f1I9hCe9Aevn5y-OfjOXkEnIzHgqDLp0S8leDIJthsF5L7qW_AocMONXdMGOvEM8Qt3cQk3UMtUzjSJ-zcnr4PYkQmvc1mxyS-QZrg92tz_Cik5XsQtEObCZEGukJ9kBYZXAXbHVF9XspcTBwlB_PIqt3h2gdgwzpo2mpSB6iQ10cm7NHcdtrNmWXJ7VqyUFaUj2r7DuH')" }}></div>
...
<p className="text-sm text-[#4b5563] dark:text-gray-300">Selam <span className="text-primary font-semibold">@Can</span>, dün gece bütçe tüketimi biraz hızlanmış görünüyor, TBM tekliflerini kontrol edebilir misin?</p>
</div>
</div>
</div>
<div className="mt-6 flex gap-3 items-start border-t border-[#e5e7eb] dark:border-[#2d3748] pt-4">
<div className="size-8 rounded-full bg-cover bg-center shrink-0" data-alt="My avatar" style={{ "backgroundImage": "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCbDYt-veoNWd5vFeMLccIQEPlgecEgXSPBrynUX67TCsVHv6VaP-nliee-Z7HGYFS1Yd382_yWRLMf-c8WmC32_UDk9MDbshY5ulx9EhVeqrurt0rd-GRkXtrk491z0FW0MY5KsdVtrz-7uKZO4J1BoEh-hYoHW5AHGbCzEKFeViw0bvYXYLaU5ZjJkrVxXXydGv_S_-JH_zZUQRZtopq-fgfPE9rXnyM5NRHbx2zX24cda6E0W3Z_jeEOdt3M1Lho77gHdssylLHS')" }}></div>
...
<div className="text-3xl font-black text-[#111418] dark:text-white font-mono">00:45:12</div>
...
<p className="text-[10px] text-gray-500">Şu anki çalışma: Anahtar Kelime Analizi</p>
</div>
</div>
...
<div className="size-8 rounded-full bg-cover bg-center" data-alt="Assignee Alex" style={{ "backgroundImage": "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBy27oCekJQlcsbTAj_ArD3C0dn0MVyI77KeDXZmawTbWqCr51UecgjguvwHcsNYkIMdgfpsrcPnVgqLwkhaydsn7PVBeSbYOboFqSUD-2W1gXAdavlYy84Hq2asbkbc_tXq3vb5l_voPof6HHrLh_kfkhzS0_rCzHoeqDOoNC_tTTPRIJpOq_v0ucx7qR6AjDccBCga6rxk5uqzhK7Sb_PjsQJIPEonfMBFCVkI-F8pmBqIaho04qIMeJWsy7egGn8qDf0j8sNyC1m')" }}></div>
...
<span className="text-xs font-medium dark:text-white truncate">performans_raporu_kasim.pdf</span>
